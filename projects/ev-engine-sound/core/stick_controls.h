...
typedef enum { EV_STICK_MAIN, EV_STICK_EXHAUST, EV_STICK_VOLUME, EV_STICK_REDLINE,
    EV_STICK_PAGE_COUNT } ev_stick_page_t;
enum {
 ...
 * B hold cycles MAIN -> EXHAUST -> VOLUME -> REDLINE -> MAIN. In settings A-/B+.
